"""
This module is copied from TangentCFT. Attribution goes to the original authors:
    (Mansouri, B., Rohatgi, S., Oard, D. W., Wu, J., Giles, C. L., & Zanibbi, R. (2019, September)).

In this version, one small bug is fixed (use math.ceil not math_tan.ceil).
Additionally support more ordered operator tags.
"""

__author__ = 'KDavila'

from TangentCFT.TangentS.math_tan.math_symbol import MathSymbol
        ...
        # generic tag operators
            ...
            if cd == "latexml":
                ...
                if content in ["annotated", "approaches-limit", "approximately-equals-or-equals",
                               ...
                               "bra", "cases", "complement", "conditional", "conditional-set",
                               "contains", "contains-as-subgroup", "contains-as-subgroup-or-equals", "continued-fraction", "contour-integral",
                               ...
                               "double-factorial", "double-integral", "double-intersection", "double-subset-of", "double-superset-of",
                               "double-union",
                               ...
                               "square-original-of", "square-original-of-or-equals", "square-union", "subgroup-of", "subgroup-of-or-equals",
